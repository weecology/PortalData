...
# assign notes
ws$notes1 <- NA
# notes1 if 1 if start/stop is suspect, 2 if start/stop switched
...
data_append <- ws[, c("year", "month", "day", "plot", "transect", "species", 'start', 'stop', "height", "notes", "notes1")]
...
# Adding notes1 column to transects file
# 
# transects =read.csv("Plants/Portal_plant_transects_2015_present.csv", header = T, na = "", sep = ",")
# 
# transects$note1 = NA
