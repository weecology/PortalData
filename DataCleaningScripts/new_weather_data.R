...
# header=read.table("~/Dropbox (UFL)/Portal/PORTAL_primary_data/Weather/Raw_data/2016_Station/511_CR1000_MET.dat",
#                    skip = 1, nrow = 1, header = FALSE, sep=",", stringsAsFactors = FALSE)
# 
# rawdata=read.table("~/Dropbox (UFL)/Portal/PORTAL_primary_data/Weather/Raw_data/2016_Station/511_CR1000_MET.dat",
...
# 
# header_storms=read.table("~/Dropbox (UFL)/Portal/PORTAL_primary_data/Weather/Raw_data/2016_Station/511_CR1000_storms.dat",
#                   skip = 1, nrow = 1, header = FALSE, sep=",", stringsAsFactors = FALSE)
# 
# stormsnew=read.table("~/Dropbox (UFL)/Portal/PORTAL_primary_data/Weather/Raw_data/2016_Station/511_CR1000_storms.dat",
#                    skip = 4, header = FALSE,sep=",") %>%
