...
pacman::p_load(curl, units, sf, shiny, stringi, stringr, Hmisc, dplyr, git2r, openxlsx, lubridate, lunar, jsonlite, 
               devtools, sp, sqldf, raster, RCurl, EML, testthat, zoo, tidyr, semver, yaml)
